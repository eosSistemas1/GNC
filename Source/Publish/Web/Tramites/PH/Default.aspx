<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TalleresWeb.Web.UI.Tramites.PH.Default" %>

<%@ Register Src="~/UserControls/MessageBoxCtrl.ascx" TagPrefix="uc1" TagName="MessageBoxCtrl" %>
<%@ Register Src="~/UserControls/CilindrosPH.ascx" TagPrefix="uc1" TagName="CilindrosPH" %>
  ...
  <main id="central" role="main">
        <div id="contenido">
            <div class="row">
                ...
                <div class="col-sm-11">
                    <strong><asp:Label ID="lblTallerDescripcion" runat="server"></asp:Label></strong>
                </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-12 no-padding">
                        <uc1:CilindrosPH runat="server" ID="CilindrosPH" />
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-3 no-padding">
                        <Controls:CboTipoDocumento ID="cboTipoDocumento" runat="server" AutomaticLoad="true" css="form-control" />
                    </div>
                    <div class="col-sm-3 no-padding">
                        <p><strong>Nro. de Doc.:&nbsp;</strong></p>
                    </div>
                    <div class="col-sm-3 no-padding">
                        <p>
                    ...
                    <div class="col-sm-9 no-padding">
                        <Controls:CboLocalidad ID="cboLocalidad" runat="server" AutomaticLoad="true" css="form-control" onchange="getCP();" />
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-sm-3 no-padding">
                        <p>CP:&nbsp;</p>
                    ...
                    <div class="col-sm-3 no-padding">
                        <p>
                            <input type="text" id="txtTelefono" class="form-control" runat="server" clientidmode="static" maxlength="20" />
                        </p>
                    </div>
                </div>                
    ...
    <script>
        ...
        function getCP() {
            ...
            var temp = document.getElementById("#<%= cboLocalidad.ClientID %>");
            var idLocalidad = temp.options[temp.selectedIndex].value;

            $.ajax({
                url: "/WebService1.asmx/GetCP",
                type: "POST",
                dataType: "json",
        ...
        $('#txtDominio').change(function () {
            ...
            $.ajax({
                url: "/WebService1.asmx/GetVehiculoByDominio",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
        ...
        $('#txtNumeroDocumento').change(function () {
            ...
            $.ajax({
                url: "/WebService1.asmx/GetClienteByDocumento",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                ...
                success: function (data) {
                    if (data != null && data.d != null) {
                        ...
                        $('#txtCodigoPostal').val(data.d.ClienteCP);
                    }
                    else {
                        $('#txtNombre').val("");
                        $('#txtDomicilio').val("");
