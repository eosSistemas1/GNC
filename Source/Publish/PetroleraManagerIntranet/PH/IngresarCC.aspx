<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IngresarCC.aspx.cs" Inherits="PetroleraManagerIntranet.Web.PH.IngresarCC" %>

<%@ Register Src="~/PH/UserControls/CilindrosPH.ascx" TagPrefix="uc1" TagName="CilindrosPH" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main id="central" role="main">
        <div id="contenido">
            <div class="row">
                <div class="col-sm-12">
                    <h4>CARTA COMPROMISO DE CONFORMIDAD</h4>
                </div>
                <hr>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-9 no-padding">
                    <Controls:CboLocalidades ID="cboLocalidad" runat="server" AutomaticLoad="true" css="form-control" onchange="getCP();" />
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-3 no-padding">
                    <p>CP:&nbsp;</p>
    ...
    <script>
        ...
        function getCP() {
            ...
            var temp = document.getElementById("MainContent_cboLocalidad");
            var idLocalidad = temp.options[temp.selectedIndex].value;

            $.ajax({
                url: "/PHService.asmx/GetCP",
                type: "POST",
                dataType: "json",
