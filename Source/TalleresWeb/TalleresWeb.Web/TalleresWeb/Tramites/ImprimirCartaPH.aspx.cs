...
namespace TalleresWeb.Web.TalleresWeb.Tramites
{
    public partial class ImprimirCartaPH : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GetDinamyc.CantCopiasCartaPH; i++)
            {
                ...
                foreach (PHCilindros cil in obj.PHCilindros)
                {
                    ...
                    String obsCil = cil.ObservacionValvulaCiindrol != null? cil.ObservacionValvulaCiindrol : String.Empty;
