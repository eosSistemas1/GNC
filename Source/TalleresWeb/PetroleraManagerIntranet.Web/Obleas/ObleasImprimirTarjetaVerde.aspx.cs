        ...
        private void GenerarTarjetaVerde(List<Guid> idObleasImprimir)
        {
            ...
            foreach (var idOblea in idObleasImprimir)
            {
                ...
                foreach (ObleasCilindros objCil in oblea.ObleasCilindros.Where(x => x.IdOperacion == MSDB.Sigue || x.IdOperacion == MSDB.Montaje))
                {
                    ...
                    String vto = "vto. " + objCil.MesUltimaRevisionCil.ToString().Trim() + "/" + Funciones.FormatearAnio((objCil.AnioUltimaRevisionCil + 5).ToString()).Substring(2, 2);
                ...
                var pec = peclogic.ReadDetalladoByID(this.PEC).FirstOrDefault();
                ...
                image = iTextSharp.text.Image.GetInstance(PageBase.UrlBase + "img/" + GetDinamyc.SelloIngeniero1);
                image.SetAbsolutePosition(320, renglon-25);
                ...
                String CodigoBarra = oblea.NroObleaNueva.Trim();
                ...
                image39.SetAbsolutePosition(415, renglon - 20);
                cb.AddImage(image39);
                #endregion
