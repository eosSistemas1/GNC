...
{
    public partial class CargarCilindrosValvulas : System.Web.UI.UserControl
    {
        ...
        protected void btnAgregar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            mensajes.Add(ValidarTipoMSDB(item));
        ...
        /// </summary>        
        private String ValidarTipoMSDB(DetalleCilindrosValvulasView item)
        {
        ...
        private DetalleCilindrosValvulasView CrearItem()
        {
            ...
            item.CRPCCilindroID = new Guid(cboCilCRPC.SelectedValue);
            item.CRPCCilindro = cboCilCRPC.SelectedItem.Text.Trim().ToUpper();
            item.MSDBCilindroID = new Guid(cboMSDBCil.SelectedValue);
            item.MSDBCilindro = cboMSDBCil.SelectedItem.Text.Trim().ToUpper();
            ...
            item.MSDBValvula1 = cboMSDBVal1.SelectedItem.Text.Trim().ToUpper();
            item.MSDBValvula1ID = new Guid(cboMSDBVal1.SelectedValue);

            item.CodigoValvula2 = txtCodigoVal2.Text.Trim().ToUpper();
            item.NroSerieValvula2 = txtSerieVal2.Text.Trim().ToUpper();
            item.MSDBValvula2 = cboMSDBVal2.SelectedItem.Text.Trim().ToUpper();
            item.MSDBValvula2ID = new Guid(cboMSDBVal2.SelectedValue);
        ...
        protected void btnModificar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            mensajes.Add(ValidarTipoMSDB(itemValidar));
        ...
        protected void gdvCilindrosValvulas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (!String.IsNullOrEmpty(e.CommandArgument.ToString()))
            {
                ...
                if (e.CommandName == "eliminar")
                {
                    ...
                    try
                    {
                        if (idObleaValvula1 != Guid.Empty) this.ObleasValvulasLogic.Delete(idObleaValvula1);
                        if (idObleaValvula2 != Guid.Empty) this.ObleasValvulasLogic.Delete(idObleaValvula2);

                        this.ObleasCilindrosLogic.Delete(idObleaCilindro);
                    }
                    catch
                    { }
        ...
        public void CargarDetalle(List<ObleasCilindrosExtendedView> cilindros, List<ObleasValvulasExtendedView> valvulas)
        {
            foreach (var cilindro in cilindros)
            {
                ...
                item.IdObleaCilindro = cilindro.ID;
        ...
        private void CargarDatosAModificar(GridViewRow filaGrilla)
        {
            ...
            cboCilCRPC.SelectedValue = gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["CRPCCilindroID"].ToString();
            cboMSDBCil.SelectedValue = gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBCilindroID"].ToString();
            ...
            if (gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula1ID"] != null &&
                gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula1ID"].ToString() != Guid.Empty.ToString())
            {
                cboMSDBVal1.SelectedValue = gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula1ID"].ToString();
            }
            ...
            if (gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula2ID"] != null &&
                gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula2ID"].ToString() != Guid.Empty.ToString())
            {
                cboMSDBVal2.SelectedValue = gdvCilindrosValvulas.DataKeys[filaGrilla.RowIndex].Values["MSDBValvula2ID"].ToString();
            }
        ...
        private List<ObleasCilindrosExtendedView> ObtenerCilindroCargados()
        {
            ...
            foreach (var item in this.detalle)
            {
                ...
                {
                    ID = item.IdObleaCilindro,
                    IDCil = item.IDCilindro,
                    IDCilUni = item.IDCilindroUnidad,
                    CodigoCil = item.CodigoCilindro,
                    NroSerieCil = item.NroSerieCilindro,
                    CilFabMes = item.CilindroFabMes,
                    CilFabAnio = item.CilindroFabAnio,
                    CilRevMes = item.CilindroRevMes,
                    CilRevAnio = item.CilindroRevAnio,
                    CRPCCilID = item.CRPCCilindroID,
                    CRPCCil = item.CRPCCilindro,
                    MSDBCilID = item.MSDBCilindroID,
                    MSDBCil = item.MSDBCilindro,
                    NroCertificadoPH = item.NroCertificadoPH.Trim().ToUpper(),
                    RealizaPH = item.RealizaPH
                };
