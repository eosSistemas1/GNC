<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PetroleraManagerIntranet.Web.Account.Login" %>
    ...
    <section class="login">
        <div class="datos text-center">
            ...
            <form id="form1" runat="server">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Ingresar" CausesValidation="false" class="btn btn-primary btn-block" OnClick="btnLogin_Click" />                
