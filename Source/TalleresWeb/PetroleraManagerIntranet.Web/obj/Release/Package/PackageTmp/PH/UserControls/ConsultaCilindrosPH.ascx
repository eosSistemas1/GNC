<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsultaCilindrosPH.ascx.cs" Inherits="PetroleraManagerIntranet.Web.PH.UserControls.ConsultaCilindrosPH" %>

<%@ Register Src="~/UserControls/MessageBoxCtrl.ascx" TagName="MessageBoxCtrl" TagPrefix="uc1" %>

<asp:HiddenField ID="hdnModificaEstado" runat="server" />
<asp:GridView ID="gdv" runat="server" AutoGenerateColumns="False" Width="100%"
    class="table table-bordered table-condensed" HeaderStyle-CssClass="text-center"
    ShowHeaderWhenEmpty="true" DataKeyNames="ID, ModificaEstado" OnRowDataBound="gdv_RowDataBound"
    ...
    <EmptyDataTemplate>
        <table border="0" style="width: 100%;">
            <tr>
                ...
                <td style="width: 7%">
                    <asp:TextBox ID="txtMesFabricacionCil" runat="server" Width="95%" class="form-control" MaxLength="2" onKeyPress="return soloNumeros(event)" />
                </td>
                <td style="width: 6%">
                ...
                <td style="width: 20%;" class="text-center">
                    <%--<Controls:CboEstadosPhConsulta ID="cboEstadosPhConsulta" runat="server"></Controls:CboEstadosPhConsulta>--%>
                </td>
            </tr>
        </table>
    </EmptyDataTemplate>
    ...
    <Columns>
        <asp:TemplateField HeaderText="Cod. Homolog. Ciliindro" FooterStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Nº Serie Ciliindro" HeaderStyle-Width="10%" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Marca" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Capacidad" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Cod. Homolog. Válvula" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Nº Serie Válvula" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Observaciones" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
            <ItemTemplate>
                <asp:Label ID="lblObservaciones" runat="server" Text='<%# Eval("Observaciones") %>' />
            </ItemTemplate>
            <FooterTemplate>
                <asp:TextBox ID="txtObservaciones" runat="server" Width="99%" MaxLength="4" class="form-control" ClientIDMode="Static" />
            </FooterTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderStyle-Width="20%" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:DropDownList ID="cboEstadosPhConsulta" runat="server" class="form-control">
                    <asp:ListItem Text="Seleccione" Value="00000000-0000-0000-0000-000000000000" />
                    <asp:ListItem Text="Verifica Códigos" Value="DF9894E1-AC41-45FD-B58B-7A5CDD9670A3" />
                    <asp:ListItem Text="Bloquea" Value="DA927ACE-BE38-4B57-951E-017BA63B5796" />
                </asp:DropDownList>
            </ItemTemplate>
            <FooterTemplate>
    ...
    <div class="modal-dialog" style="left: 0px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-sm-9">
                    <input type="text" id="txtMarcaCilMod" maxlength="50" class="form-control" runat="server" clientidmode="static" />
                </div>
                <div class="clearfix"></div>

                <div class="col-sm-3">Capacidad:</div>
                <div class="col-sm-9">
                    <input type="text" id="txtCapacidadCilMod" maxlength="20" class="form-control" runat="server" clientidmode="static" />
                </div>
                <div class="clearfix"></div>
