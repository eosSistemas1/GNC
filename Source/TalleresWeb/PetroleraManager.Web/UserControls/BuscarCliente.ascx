<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuscarCliente.ascx.cs"
    Inherits="PetroleraManager.Web.UserControls.BuscarCliente" %>
<table id="tblToolBar" cellspacing="2" cellpadding="1" width="100%" align="left"
    border="0">
    <tr>
        <td align="right">
            <PLs:PLLabel ID="lblSearch" runat="server">Cliente:</PLs:PLLabel>
        </td>
        <td align="left">
...
<PLs:PLPanel ID="Panel1" runat="server" CssClass="CajaDialogo" Width="100%">
    <fieldset>
        <legend><span class="LabelLegend">Clientes</span></legend>
        <div style="overflow: auto; height: 300px;">
            <PLs:PLGridView ID="dgClientes" runat="server" Width="100%" CellPadding="2" AllowSorting="True"
                AlternatingRowStyle-CssClass="GridAlternateRow" HeaderStyle-CssClass="GridHeader" RowStyle-CssClass="GridRow"
                AutoGenerateColumns="False" OnSelectedIndexChanged="dgClientes_SelectedIndexChanged"
                DataKeyNames="ID">
                <Columns>
