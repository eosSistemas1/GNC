<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuscarProductoLote.ascx.cs"
    Inherits="PetroleraManager.Web.UserControls.BuscarProductoLote" %>
...
<PLs:PLPanel ID="Panel1" runat="server" CssClass="CajaDialogo" Width="100%">
    <fieldset>
        ...
        <div style="overflow: auto; height: 300px;">
            <PLs:PLGridView ID="dgProductoLote" runat="server" Width="100%" CellPadding="2" AllowSorting="True"
                AlternatingRowStyle-CssClass="GridAlternateRow" HeaderStyle-CssClass="GridHeader" RowStyle-CssClass="GridRow"
                AutoGenerateColumns="False" OnSelectedIndexChanged="dgProductoLote_SelectedIndexChanged"
                DataKeyNames="ID, ProductoLoteID">
                <Columns>
                    <asp:BoundField DataField="Descripcion" ReadOnly="True" HeaderText="Descripción">
                    </asp:BoundField>
                    <asp:BoundField DataField="CodigoProducto" ReadOnly="True" HeaderText="Código"></asp:BoundField>
                    <asp:BoundField DataField="Lote" ReadOnly="True" HeaderText="Lote"></asp:BoundField>
                    <asp:BoundField DataField="FechaVencimiento" ReadOnly="True" HeaderText="F. Venc."
                        DataFormatString="{0:M-dd-yyyy}"></asp:BoundField>
                    <asp:BoundField DataField="CantidadExistente" ReadOnly="True" HeaderText="Cant. Existente">
                    </asp:BoundField>
