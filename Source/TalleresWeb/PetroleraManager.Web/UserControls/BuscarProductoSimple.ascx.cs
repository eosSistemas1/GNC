...
{
    public partial class BuscarProductoSimple : System.Web.UI.UserControl
    {
        ...
        {
            var resultadoPorCodigo = lista.ReadProductoSimpleByCodigo(txtSearch.Text.Trim()).ToList();

            var resultado = lista.ReadProductoSimpleByDescripcion(txtSearch.Text.Trim()).ToList();
    ...
    //LOS EVENTOS ESTAN DEFINIDOS EN EL BUSCADOR DE PRODUCTOS
