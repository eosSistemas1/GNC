<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuscarConcepto.ascx.cs"
    Inherits="PetroleraManager.Web.UserControls.BuscarConcepto" %>
<table id="tblToolBar" cellspacing="0" cellpadding="0" width="95%" align="left" border="0">
    <tr>
        <td align="right">
            <PLs:PLLabel ID="lblSearch" runat="server"></PLs:PLLabel>
        </td>
        <td align="left">
        ...
        <td>
            <PLs:PLTextBox ID="txtSearch" WidthTxt="100%" runat="server"></PLs:PLTextBox>
        </td>
...
<PLs:PLPanel ID="Panel1" runat="server" CssClass="CajaDialogo" Width="100%">
    <fieldset>
        <legend><span class="LabelLegend">Conceptos</span></legend>
        <div style="overflow: auto; height: 300px;">
        <PLs:PLGridView ID="dgConceptos" runat="server" Width="100%" CellPadding="2" AllowSorting="True"
            AlternatingRowStyle-CssClass="GridAlternateRow" HeaderStyle-CssClass="GridHeader" RowStyle-CssClass="GridRow"
            AutoGenerateColumns="False" OnSelectedIndexChanged="dgConceptos_SelectedIndexChanged"
            DataKeyNames="ID, ProductoLoteID">
            <Columns>
                <asp:BoundField DataField="Descripcion" ReadOnly="True" HeaderText="Concepto"></asp:BoundField>
