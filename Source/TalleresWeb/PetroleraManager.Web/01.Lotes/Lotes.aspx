<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Lotes.aspx.cs" Inherits="PetroleraManager.Web.Lotes.Lotes" %>
                        ...
                        <table width="100%" border="0" style="vertical-align: top;">
                            <tr>
                                <td>
                                    ...
                                    <span>Fecha Ingreso:<input type="text" id="txtFecha" runat="server" class="date" style="width: 90px" clientidmode="Static" maxlength="10" /></span>
                                </td>
                                <td>
                                    <span>Año Vencimiento:<input type="text" id="txtAnioVencimiento" runat="server" class="number" style="width: 90px" clientidmode="Static" maxlength="4" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span>Nro. Oblea Desde:<input type="text" id="txtNumeroObleaDesde" runat="server"  class="number" style="width: 90px" clientidmode="Static" maxlength="10" /></span>
                                </td>
                                <td>
                                    <span>Nro. Oblea Hasta:<input type="text" id="txtNumeroObleaHasta" runat="server" class="number" style="width: 90px" clientidmode="Static" maxlength="10" /></span>                                    
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
