<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Reguladores.aspx.cs" Inherits="PetroleraManager.Web.Sistema.Reguladores" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <fieldset>
            ...
            <PLs:PLTabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%" style="height:150px">
                <PLs:PLTabPanel runat="server" HeaderText="Regulador" ID="TabPanel1">
                    <ContentTemplate>
                        ...
                        <Controls:CboMarcasReguladores ID="cboMarcasReguladores" runat="server" LabelText="Marca:" AutomaticLoad="true" IsComboFilter="True" />
                        <PLs:PLTextBox ID="txtModeloReg" runat="server" LabelText="Modelo:" />
                        <PLs:PLTextBox ID="txtMatriculaOCReg" runat="server" LabelText="Matricula OC:" />
                        <PLs:PLTextBoxMasked ID="txtCaudalReg" runat="server" LabelText="Caudal:" Mask="9999" MaskType="Number" />
                        <PLs:PLTextBoxMasked ID="txtEtapasReg" runat="server" LabelText="Caudal:" Mask="9" MaskType="Number" />
                        <PLs:PLTextBox ID="txtTipoReg" runat="server" LabelText="Tipo:" />
                    </ContentTemplate>
                </PLs:PLTabPanel>
            </PLs:PLTabContainer>
        </fieldset>
