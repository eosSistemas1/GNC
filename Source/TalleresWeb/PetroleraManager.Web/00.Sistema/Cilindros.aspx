<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Cilindros.aspx.cs" Inherits="PetroleraManager.Web.Sistema.Cilindros" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <fieldset>
            ...
            <PLs:PLTabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%" style="height:150px">
                <PLs:PLTabPanel runat="server" HeaderText="Cilindro" ID="TabPanel1">
                    <ContentTemplate>
                        ...
                        <PLs:PLTextBoxMasked ID="txtCapacidad" runat="server" LabelText="Capacidad:" Mask="9999" MaskType="Number" />
                        <Controls:CboMarcasCilindros ID="cboMarcasCilindros" runat="server" LabelText="Marca:" AutomaticLoad="true" IsComboFilter="True" /> 
                        <PLs:PLTextBox ID="txtMAtriculaOCCil" runat="server" LabelText="Matricula OC:" />
                        <PLs:PLTextBox ID="txtModeloCil" runat="server" LabelText="Modelo:" />
                    </ContentTemplate>
                </PLs:PLTabPanel>
                <PLs:PLTabPanel runat="server" HeaderText="Datos técnicos" ID="TabPanel2">
                    <ContentTemplate>
                        <PLs:PLTextBox ID="txtEspesor" runat="server" LabelText="Espesor admisible:" />
                        <PLs:PLTextBox ID="txtDiametro" runat="server" LabelText="Diametro:" />
                        <PLs:PLTextBox ID="txtLargo" runat="server" LabelText="Largo:" />
                        <PLs:PLTextBox ID="txtRotura" runat="server" LabelText="Rotura:" />
                        <PLs:PLTextBox ID="txtMaterial" runat="server" LabelText="Materia:" />
                        <PLs:PLTextBox ID="txtNormaFab" runat="server" LabelText="Norma fabricación:" />
                    </ContentTemplate>
                </PLs:PLTabPanel>
            </PLs:PLTabContainer>
        </fieldset>
