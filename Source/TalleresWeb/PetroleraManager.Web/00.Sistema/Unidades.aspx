<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Unidades.aspx.cs" Inherits="PetroleraManager.Web.Sistema.Unidades" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <fieldset>
            <p style="text-align: right;">
                ...
                <PLs:PLButton ID="btnAceptar" runat="server" Text="Aceptar" OnClick="btnAceptar_Click" ImageUrl="../Imagenes/Iconos/correcta.png" />
                <PLs:PLButton ID="btnCancelar" runat="server" Text="Cancelar" OnClick="btnCancelar_Click" CausesValidation="false" ImageUrl="../Imagenes/Iconos/bloqueada.png"/>
            </p>
                        ...
                        <table width="100%" border="0" style="vertical-align: top;">
                            <tr>
                                <td>
                                    ...
                                    <PLs:PLTextBoxMasked ID="txtCoeficiente" runat="server" LabelText="Coeficiente:"
                                        Required="true" Mask="9999.99" MaskType="Number" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
