...
{
    public partial class Unidades : PageBase
    {
        UNIDADES item = new UNIDADES();
        UnidadesLogic logic = new UnidadesLogic();
        UnidadesParameters param = new UnidadesParameters();
        ...
        private void CargarDatos(Guid idItem)
        {
            ...
            txtCoeficiente.Text = item.Coeficiente.ToString();
        }
        ...
        {  
            ...
            item.Coeficiente = Decimal.Parse(txtCoeficiente.Text);
            item.Activo = true;
