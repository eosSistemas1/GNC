...
{
    public partial class PHRecepcionCilindros : PageBase
    {
        ...
        private void CargarGrilla()
        {
            ...
            param.EstadoFichaPendiente = DatosDiscretos.ESTADOSPH.EnEsperaCilindros;
            param.EstadoFichaBloqueada = DatosDiscretos.ESTADOSPH.EnEsperaCilindros;
            ...
            if (obleas.Count > 0)
            {
                ...
                foreach (PHCILINDROSExtendedView o in obleas)
                {
                    ...
                    if (idTallerAnterior != o.IdTaller)
                    {
                        ...
                        titBtnProcesar.Text = "RECEPCION CILINDROS";
