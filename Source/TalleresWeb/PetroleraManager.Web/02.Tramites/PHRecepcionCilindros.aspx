<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PHRecepcionCilindros.aspx.cs" Inherits="PetroleraManager.Web.Tramites.PHRecepcionCilindros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <br />
    <h2>
        <PLs:PLLabel ID="lblTituloPagina" runat="server" Text="Recepción de cilindros:"></PLs:PLLabel></h2>
