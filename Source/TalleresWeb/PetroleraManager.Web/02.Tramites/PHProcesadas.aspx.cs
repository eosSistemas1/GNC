...
{
    public partial class PHProcesadas : PageBase
    {
        ...
        private void CargarGrilla()
        {
            ...
            param.EstadoFichaPendiente = DatosDiscretos.ESTADOSPH.EnProceso;
            param.EstadoFichaBloqueada = DatosDiscretos.ESTADOSPH.EnProceso;
            ...
            if (obleas.Count > 0)
            {
                ...
                foreach (PHCILINDROSExtendedView o in obleas)
                {
                    ...
                    if (idTallerAnterior != o.IdTaller)
                    {
                        ...
                        titBtnProcesar.Text = "HOJA DE RUTA";
                    ...
                    String urlProcesamiento = SiteMaster.UrlBase + @"02.Tramites/PHCargarHojaRuta.aspx?idCP=" + o.ID;
