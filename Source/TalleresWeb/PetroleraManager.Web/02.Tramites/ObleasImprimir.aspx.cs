...
{
    public partial class ObleasImprimir : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Recupero la oblea
            var obj = logic.ReadDetalladoByID(idOblea);
            ...
            foreach (ObleasCilindros objCil in obj.ObleasCilindros)
            {
                ...
                string anioFabCilindro = objCil.CilindrosUnidad.AnioFabCilindro.HasValue ? genericos.FormatearAnio(objCil.CilindrosUnidad.AnioFabCilindro.Value.ToString()).Substring(2, 2) : String.Empty;
                ...
                cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, genericos.FormatearAnio(objCil.AnioUltimaRevisionCil.ToString()).Substring(2, 2), 330, renglon, 0);
