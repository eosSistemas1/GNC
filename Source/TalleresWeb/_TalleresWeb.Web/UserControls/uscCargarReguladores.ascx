<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscCargarReguladores.ascx.cs" Inherits="TalleresWeb.Web.UserControls.uscCargarReguladores" %>
        ...
        <fieldset class="aField">
            ...
            <div style="overflow: auto; min-height: 100px; height: 100px">
                <asp:GridView ID="gdv" runat="server" AutoGenerateColumns="False" Width="100%" ShowFooter="True"
                    ShowHeaderWhenEmpty="true" DataKeyNames="ID, IDReg, IDRegUni, MSDBRegID" OnRowCommand="grdDetalle_RowCommand"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td width="30%" align="center">
                                    <PEARGNC:CboMSDB ID="cboMSDBReg" runat="server" AutomaticLoad="true" Width="100%" WidthCbo="99%" />
                                </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="MSDB" HeaderStyle-Width="30%" FooterStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                ...
                                <PEARGNC:CboMSDB ID="cboMSDBReg" runat="server" AutomaticLoad="true"  Visible="false" WidthCbo="99%"/>
                            </ItemTemplate>
                            <FooterTemplate>
                                <PEARGNC:CboMSDB ID="cboMSDBReg" runat="server" AutomaticLoad="true" WidthCbo="99%"/>
                            </FooterTemplate>
                        </asp:TemplateField>
