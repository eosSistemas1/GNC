...
namespace TalleresWeb.Web
{
    public partial class red_de_talleres : System.Web.UI.Page
    {
        ...
        {
            //Nucleo.BLL.Provincias obj = new Nucleo.BLL.Provincias();
            //obj.LoadProvinciasDeTalleres();
            //obj.Sort = "Provincia";
            //cboProvincias.DataTextField = "Provincia";
            //cboProvincias.DataValueField = "IdProvincia";
            //cboProvincias.DataSource = obj.DefaultView;
